...
Modal analysis provide an understanding of material frequency response,
...
historic musical instruments. Non-contact methods for analysis are an appealing
method for modal analysis for fragile or expensive instruments. 

Laser vibrometry has long been a useful tool for acoustic analysis
\cite{SRIRIAM}. With respect to musical instruments, laser vibrometry provides a
non-obtrusive means of obtaining accurate results, however it does have a
limitation in the form of cost. A modest laser doppler vibrometer (LDV) cost in
the order of €20k. In addition, estimation of material properties of soundboards
comes with an additional cost of Finite Element Method modelling software. This
is a cost that is difficult to justify for the usage it would see by instrument
collector and museums. The market for laser vibrometer is also dominated by a
handful of companies and it seems unlikely this cost will shrink any time soon.
Laser vibrometers are precision engineered for all vibration analysis, a level
accuracy unlikely to be utlilsed when applied to musical instruments. 
...
This section will discuss some recent projects focused on the topics of
non-contact, automated modal analysis and making the process more economically
accessible. I will then elaborate on how the proposed projects intends to
enhance and build on these projects. 
...
fabricating a GLV economically. This project would expand on Matiss's work by
exploring the construction of both affordable LDV and GLV measurement units, in
particular with an application to soundboards. Measuring musical instrument
soundboard does not require as wide a frequency bandwidth compared to other
...
would require facilities to aid prototyping. Suppliers RS and Element 14 were
used as a source for guide prices:
...
\paragraph{Laser Components}\label{laser-components}}
  ...
  \item
    ...
    alternative would aso be sought to improve sensor bandwidth. (Guide Price: £0.70)
  \item
  ...
  \item
    ...
    available. (Guide Price: £400). They consist of: 
    \begin{itemize}
    \tightlist
    \item
