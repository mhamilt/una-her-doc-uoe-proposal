...
\cite{SRIRIAM}. With respect to musical insrtuments, Modes give an understanding of
...
The 3D printed impact hammer used for measurements  in \cite{RAU} can also be
...
Laser Doppler Vibrometer and Grazing Laser Vibrometer

\begin{figure}%
  \centering
  \subfloat[\centering LDV Block Diagram]{{\includegraphics[width=5cm]{./img/ldv-block.png} }}%
  \qquad
  \subfloat[\centering GLV Block Diagrams]{{\includegraphics[width=5cm]{./img/grv-block.png} }}%
...
outlined in \cite{FARSHIDI2010755} and may be accurate enough for estimating material
...
\paragraph{Laser Components}\label{laser-components}}
  ...
  \item
    ...
    as a kit or assembled from seprate parts if a suitable size is not
...
correctly and constitute the bulk of the cost of fabrication

\begin{itemize}
\tightlist
\item
  Beam Splitter: Allows for redirection of laser beam into two direction.
\item
...
\item
  ...
  omit this comonent entirely.
\item
  Focal Lens: (Optional) Should the laser beam need to be focused into a fibre
  optic cable, a beam splitter would be necessary.
\end{itemize}
